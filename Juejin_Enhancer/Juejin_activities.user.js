...
<p style="display:flex;align-items:center;color:#939aa3a3;justify-content:space-between"><img style="width: 80px" src="${articleCount < 8 ? img$5 : img$6}"/><span style="font-size:10px;margin-left:4px;">${articleCount < 8 ? "达到 8 篇即可参与抽奖" : "可参与抽奖"}</span></p>
<p>
